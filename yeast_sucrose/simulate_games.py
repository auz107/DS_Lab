...
def master_func(start_pos = None, end_pos = None, capture_efficiency = 0.99, SUCRe_atp = 0.115, histidine_uptake_rate = 10, glucose_uptake_rate = 0, fructose_uptake_rate = 0, o2_uptake_rate = 2, simulate_his = True, fixed_o2 = False, task = 'analyze_games', warnings = True, stdout_msgs = True, results_filename = ''):
    ...
    glc_D_e = iAZ900.get_compounds({'glc_D_e':'id'})
    glc_D_e.ms_calc(stdout_msgs = False, warnings = False)
    glc_D_e.biomass_yield_calc(stdout_msgs = False, warnings = False)
    mu_death_glc_D = - glc_D_e.biomass_yield*glc_D_e.ms 
    fru_e = iAZ900.get_compounds({'fru_e':'id'})
    fru_e.ms_calc(stdout_msgs = False, warnings = False)
    fru_e.biomass_yield_calc(stdout_msgs = False, warnings = False)
...
if __name__ == '__main__':
    ...
    sucrose_game = master_func(capture_efficiency = 0.3, SUCRe_atp = 1.2, histidine_uptake_rate = 0, glucose_uptake_rate = 0, fructose_uptake_rate = 0, o2_uptake_rate = 2, simulate_his = False, fixed_o2 = True, task = 'analyze_games', warnings = True, stdout_msgs = True, results_filename = '')
